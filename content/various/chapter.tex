...
\section{Intervals}
	\bombaimport{IntervalContainer.h}
	\bombaimport{IntervalCover.h}
	\bombaimport{ConstantIntervals.h}

\section{Misc. algorithms}
	\bombaimport{TernarySearch.h}
	\bombaimport{LIS.h}
	\bombaimport{FastKnapsack.h}

\section{Dynamic programming}
	\bombaimport{KnuthDP.h}
	\bombaimport{DivideAndConquerDP.h}
...
\section{Optimization tricks}
	...
	\subsection{Pragmas}
		...
		\end{itemize}
	\bombaimport{FastMod.h}
	\bombaimport{FastInput.h}
	\bombaimport{BumpAllocator.h}
	\bombaimport{SmallPtr.h}
	\bombaimport{BumpAllocatorSTL.h}
	% \bombaimport{Unrolling.h}
	\bombaimport{SIMD.h}
